...
G4ReactionProduct * ParticleHPDiscreteTwoBody::Sample(G4double anEnergy, G4double massCode, G4double )
{ // Interpolation still only for the most used parts; rest to be Done @@@@@
   ...
   {
     throw G4HadronicException(__FILE__, __LINE__, "ParticleHPDiscreteTwoBody: Unknown ion case 2");
   }
