...
ParticleHPElastic::ParticleHPElastic() 
...
G4HadFinalState * ParticleHPElastic::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& aNucleus)
{
...
//--------------------------------------------------------
G4HadFinalState * ParticleHPElastic::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& aNucleus, G4bool isFromTSL)
{
...
const std::pair<G4double, G4double> ParticleHPElastic::GetFatalEnergyCheckLevels() const
{
...
G4int ParticleHPElastic::GetVerboseLevel() const 
{
   return ParticleHPManager::GetInstance()->GetVerboseLevel();
}


void ParticleHPElastic::SetVerboseLevel( G4int newValue ) 
{
   ParticleHPManager::GetInstance()->SetVerboseLevel(newValue);
}


void ParticleHPElastic::BuildPhysicsTable(const G4ParticleDefinition&)
{
   ...
   if ( G4Threading::IsMasterThread() ) {
      ...
      if ( theElastic == nullptr ) theElastic = new std::vector<ParticleHPChannel*>;
      ...
      ParticleHPElasticFS * theFS = new ParticleHPElasticFS;
      ...
      for ( G4int i = numEle ; i < (G4int)G4Element::GetNumberOfElements() ; i++ ) {
         theElastic->push_back( new ParticleHPChannel );
...
void ParticleHPElastic::ModelDescription(std::ostream& outFile) const
{
