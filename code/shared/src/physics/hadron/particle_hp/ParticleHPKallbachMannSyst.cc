...
G4double ParticleHPKallbachMannSyst::Sample(G4double anEnergy)
{
  G4double result;
...
G4double ParticleHPKallbachMannSyst::Kallbach(G4double cosTh, G4double anEnergy)
{
...
G4double ParticleHPKallbachMannSyst::GetKallbachZero(G4double anEnergy)
{
  G4double result;
...
G4double ParticleHPKallbachMannSyst::A(G4double anEnergy)
{ 
  G4double result;
...
G4double ParticleHPKallbachMannSyst::SeparationEnergy(G4int Ac, G4int Nc, G4int AA, G4int ZA,G4int Abinding,G4int Zbinding)
{
  G4double result;
  G4int NA = AA-ZA;
  G4int Zc = Ac-Nc;
