...
void ParticleHPDeExGammas::Init(std::istream & aDataFile)
{
  //  G4cout << this << "ExGammas Init LEVEL " << G4endl; //GDEB
  ParticleHPGamma ** theGammas = new ParticleHPGamma * [50];
  G4int nGammas = 0;
  G4int nBuff = 50;
  for(;;)
  {
    ParticleHPGamma * theNew = new ParticleHPGamma;
    ...
    else
    {
      ...
      {
        nBuff+=50;
        ParticleHPGamma ** buffer = new ParticleHPGamma * [nBuff];
  ...
  theLevels = new ParticleHPLevel[nLevels];
