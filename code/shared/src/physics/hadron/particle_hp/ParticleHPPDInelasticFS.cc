...
ParticleHPPDInelasticFS::ParticleHPPDInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID("model_ParticleHPPDInelasticFS_F34");
}

G4HadFinalState* ParticleHPPDInelasticFS::ApplyYourself(const G4HadProjectile& theTrack)
{
...
void ParticleHPPDInelasticFS::Init(G4double A, G4double Z, G4int M, G4String& dirName,
