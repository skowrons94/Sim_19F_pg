...
#include "G4Threading.hh"
  ...
  ParticleHPVector & operator + (ParticleHPVector & left, ParticleHPVector & right)
  {
    ParticleHPVector * result = new ParticleHPVector;
    G4int j=0;
    G4double x;
    G4double y;
    G4int running = 0;
  ...
  ParticleHPVector::ParticleHPVector()
  {
    theData = new ParticleHPDataPoint[20]; 
    nPoints=20;
    nEntries=0;
    Verbose=0;
    theIntegral=0;
  ...
  ParticleHPVector::ParticleHPVector(G4int n)
  {
    nPoints=std::max(n, 20);
    theData = new ParticleHPDataPoint[nPoints]; 
    nEntries=0;
    Verbose=0;
    theIntegral=0;
    totalIntegral=-1;
  ...
  ParticleHPVector::~ParticleHPVector()
  {
//    if(Verbose==1)G4cout <<"ParticleHPVector::~ParticleHPVector"<<G4endl;
      delete [] theData;
...
//    if(Verbose==1)G4cout <<"Vector: delete theIntegral"<<G4endl;
  ...
  ParticleHPVector & ParticleHPVector::  
  operator = (const ParticleHPVector & right)
  {
  ...
  G4double ParticleHPVector::GetXsec(G4double e) 
  {
...
//      if (i!=1&&i==5*(i/5)) G4cout << G4endl;
  ...
  void ParticleHPVector::Check(G4int i)
  {
    if(i>nEntries) throw G4HadronicException(__FILE__, __LINE__, "Skipped some index numbers in ParticleHPVector");
    if(i==nPoints)
    {
      nPoints = static_cast<G4int>(1.2*nPoints);
      ParticleHPDataPoint * buff = new ParticleHPDataPoint[nPoints];
  ...
  void ParticleHPVector::
  Merge(G4InterpolationScheme aScheme, G4double aValue, 
        ParticleHPVector * active, ParticleHPVector * passive)
  { 
  ...
  void ParticleHPVector::ThinOut(G4double precision)
  {
    // anything in there?
    if(GetVectorLength()==0) return;
    // make the new vector
    ParticleHPDataPoint * aBuff = new ParticleHPDataPoint[nPoints];
  ...
  G4bool ParticleHPVector::IsBlocked(G4double aX)
  {
    G4bool result = false;
  ...
  G4double ParticleHPVector::Sample() // Samples X according to distribution Y
  {
    G4double result;
    G4int j;
...
//080807
  ...
  G4double ParticleHPVector::Get15percentBorder()
  {    
  ...
  G4double ParticleHPVector::Get50percentBorder()
  {    
