...
ParticleHPMessenger::ParticleHPMessenger( ParticleHPManager* man )
:manager(man)
{
...
ParticleHPMessenger::~ParticleHPMessenger()
{
...
void ParticleHPMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{
   G4bool bValue = false;
   ...
   if ( command == PhotoEvaCmd ) {
     if ( manager->GetUseOnlyPhotoEvaporation() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== ParticleHPMessenger CHANGED PARAMETER UseOnlyPhotoEvaporation TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == SkipMissingCmd) {
     if ( manager->GetSkipMissingIsotopes() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== ParticleHPMessenger CHANGED PARAMETER SkipMissingIsotopes TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == NeglectDopplerCmd ) {
     if ( manager->GetNeglectDoppler() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== ParticleHPMessenger CHANGED PARAMETER NeglectDoppler TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == DoNotAdjustFSCmd ) {
     if ( manager->GetDoNotAdjustFinalState() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== ParticleHPMessenger CHANGED PARAMETER DoNotAdjustFinalState TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == ProduceFissionFragementCmd ) { 
     if ( manager->GetProduceFissionFragments() != bValue ) {
      manager->SetProduceFissionFragments( bValue );
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== ParticleHPMessenger CHANGED PARAMETER ProduceFissionFragments TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == WendtFissionModelCmd ) { 
     if ( manager->GetUseWendtFissionModel() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== ParticleHPMessenger CHANGED PARAMETER UseWendtFissionModel TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == NRESP71Cmd ) { 
     if ( manager->GetUseNRESP71Model() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== ParticleHPMessenger CHANGED PARAMETER UseNRESP71Model TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == VerboseCmd ) {
     ...
     if ( manager->GetVerboseLevel() != verboseLevel  ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== ParticleHPMessenger CHANGED PARAMETER VerboseLevel TO "
	        << verboseLevel << " ===" << G4endl;
       }
       #endif
     }      
