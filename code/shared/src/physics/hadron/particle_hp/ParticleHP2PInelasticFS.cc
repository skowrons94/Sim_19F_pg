...
ParticleHP2PInelasticFS::ParticleHP2PInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID("model_ParticleHP2PInelasticFS_F30");
}

G4HadFinalState* ParticleHP2PInelasticFS::ApplyYourself(const G4HadProjectile& theTrack)
{
...
void ParticleHP2PInelasticFS::Init(G4double A, G4double Z, G4int M, G4String& dirName,
