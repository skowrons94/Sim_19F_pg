...
G4ReactionProduct * ParticleHPNBodyPhaseSpace::Sample(G4double anEnergy, G4double massCode, G4double )
{
   ...
   {
     throw G4HadronicException(__FILE__, __LINE__, "ParticleHPNBodyPhaseSpace: Unknown ion case 2");
   }
