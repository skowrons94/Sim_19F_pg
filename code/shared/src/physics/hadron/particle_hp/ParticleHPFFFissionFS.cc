...
//
#include "ParticleHPFFFissionFS.hh"
#include "ParticleHPManager.hh"
#include "G4SystemOfUnits.hh"

ParticleHPFFFissionFS::~ParticleHPFFFissionFS()
{
...
void ParticleHPFFFissionFS::Init (G4double A, G4double Z, G4int M, G4String & dirName, G4String & , G4ParticleDefinition*)
{
   //G4cout << "ParticleHPFFFissionFS::Init" << G4endl;
   G4String aString = "FF";

   G4String tString = dirName;
   G4bool dbool;
   ParticleHPDataUsed aFile = theNames.GetName(static_cast<G4int>(A), static_cast<G4int>(Z), M, tString, aString , dbool);
...
G4DynamicParticleVector * ParticleHPFFFissionFS::ApplyYourself(G4int nNeutrons)
{  
   G4DynamicParticleVector * aResult;
//    G4cout <<"ParticleHPFFFissionFS::ApplyYourself +"<<G4endl;
   aResult = ParticleHPFissionBaseFS::ApplyYourself(nNeutrons);    
   return aResult;
}

void ParticleHPFFFissionFS::GetAFissionFragment( G4double energy , G4int& fragZ , G4int& fragA , G4int& fragM )
{
   //G4cout << "ParticleHPFFFissionFS::GetAFissionFragment " << G4endl;
