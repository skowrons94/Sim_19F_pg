...
ParticleHPPAInelasticFS::ParticleHPPAInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID("model_ParticleHPPAInelasticFS_F31");
}

G4HadFinalState* ParticleHPPAInelasticFS::ApplyYourself(const G4HadProjectile& theTrack)
{
...
void ParticleHPPAInelasticFS::Init(G4double A, G4double Z, G4int M, G4String& dirName,
