...
//
#include "ParticleHPJENDLHEData.hh"
...
G4bool ParticleHPJENDLHEData::IsApplicable(const G4DynamicParticle*aP, const G4Element* anE)
{
...
ParticleHPJENDLHEData::ParticleHPJENDLHEData()
{
...
ParticleHPJENDLHEData::ParticleHPJENDLHEData( G4String reaction , G4ParticleDefinition* pd )
...
void ParticleHPJENDLHEData::BuildPhysicsTable( const G4ParticleDefinition& aP )
{
...
void ParticleHPJENDLHEData::DumpPhysicsTable(const G4ParticleDefinition& aP)
{
  if(&aP!=G4Neutron::Neutron()) 
     throw G4HadronicException(__FILE__, __LINE__, "Attempt to use NeutronHP data for particles other than neutrons!!!");  
//  G4cout << "ParticleHPJENDLHEData::DumpPhysicsTable still to be implemented"<<G4endl;
}



G4double ParticleHPJENDLHEData::
...
G4PhysicsVector* ParticleHPJENDLHEData::readAFile ( std::fstream* file )
{
...
G4bool ParticleHPJENDLHEData::isThisInMap( G4int z , G4int a )
{
...
void ParticleHPJENDLHEData::registAPhysicsVector( G4int Z , G4int A , G4PhysicsVector* aPhysVec )
{
...
G4double ParticleHPJENDLHEData::getXSfromThisIsotope( G4int Z , G4int A , G4double ek )
{
