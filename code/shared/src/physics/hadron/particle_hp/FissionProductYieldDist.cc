...
//
/*
 * File:   FissionProductYieldDist.cc
...
#include "FissionProductYieldDist.hh"
#include "G4Pow.hh"
...
G4Mutex FissionProductYieldDist::fissprodMutex = G4MUTEX_INITIALIZER;
#endif

FissionProductYieldDist::
FissionProductYieldDist( G4int WhichIsotope,
...
void FissionProductYieldDist::Initialize(std::istringstream& dataStream)
{
G4FFG_FUNCTIONENTER__
  ...
  SetNubar();
    ...
    // Construct NeutronHPNames: provides access to the element names
    ElementNames_ = new ParticleHPNames;
    ...
    try
    {
        ...
        ENDFData_ = new ENDFTapeRead(dataStream,
                                       YieldType_,
                                       Cause_,
                                       Verbosity_);
//        ENDFData_ = new ENDFTapeRead(MakeDirectoryName(),
...
G4DynamicParticleVector* FissionProductYieldDist::G4GetFission(void)
{
G4FFG_FUNCTIONENTER__

#ifdef G4MULTITHREADED
  G4AutoLock lk(&FissionProductYieldDist::fissprodMutex);
#endif
  ...
  // FissionProductYieldDist::G4GetFissionProduct() for more information
  ...
  if (Verbosity_ & G4FFGEnumerations::DAUGHTER_INFO) {
    ...
    // is not always traveling along the positive z-axis
        ...
        if(PossibleImbalance > 0.01)
        {
            ...
            G4Exception("FissionProductYieldDist::G4GetFission()",
                        Temp.str().c_str(),
                        JustWarning,
...
G4Ions* FissionProductYieldDist::
...
G4String FissionProductYieldDist::
...
G4DynamicParticle* FissionProductYieldDist::
