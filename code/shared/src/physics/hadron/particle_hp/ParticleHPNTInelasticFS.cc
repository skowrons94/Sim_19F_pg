...
ParticleHPNTInelasticFS::ParticleHPNTInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID("model_ParticleHPNTInelasticFS_F14");
}

G4HadFinalState* ParticleHPNTInelasticFS::ApplyYourself(const G4HadProjectile& theTrack)
{
...
void ParticleHPNTInelasticFS::Init(G4double A, G4double Z, G4int M, G4String& dirName,
