...
ParticleHPN2AInelasticFS::ParticleHPN2AInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID("model_ParticleHPN2AInelasticFS_F11");
}

G4HadFinalState* ParticleHPN2AInelasticFS::ApplyYourself(const G4HadProjectile& theTrack)
{
...
void ParticleHPN2AInelasticFS::Init(G4double A, G4double Z, G4int M, G4String& dirName,
