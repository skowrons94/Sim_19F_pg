...
ParticleHPThermalScatteringNames::ParticleHPThermalScatteringNames()
{
...
G4bool ParticleHPThermalScatteringNames::IsThisThermalElement( G4String aname)
{
   G4bool result = false;
...
G4bool ParticleHPThermalScatteringNames::IsThisThermalElement( G4String material , G4String element )
{
   G4bool result = false;
...
void ParticleHPThermalScatteringNames::AddThermalElement ( G4String nameG4Element , G4String filename)
{  
