...
#include "G4SystemOfUnits.hh"
  ...
  G4double ParticleHPMadlandNixSpectrum::Madland(G4double aSecEnergy, G4double tm)
  {
  ...
  G4double ParticleHPMadlandNixSpectrum::Sample(G4double anEnergy) 
  {
  ...
  G4double ParticleHPMadlandNixSpectrum::
