...
//
#include "ParticleHPFSFissionFS.hh"
...
#include "ParticleHPDataUsed.hh"
  ...
  void ParticleHPFSFissionFS::Init (G4double A, G4double Z, G4int M, G4String & dirName, G4String &, G4ParticleDefinition*  )
  {
    G4String tString = "/FS/";
    G4bool dbool;
    ParticleHPDataUsed aFile = theNames.GetName(static_cast<G4int>(A), static_cast<G4int>(Z), M, dirName, tString, dbool);
    ...
    while (theData >> infoType) // Loop checking, 11.05.2015, T. Koi
    {
      ...
      switch(infoType)
      {
        ...
        case 5:
          ...
          break;
        default:
          G4cout << "ParticleHPFSFissionFS::Init: unknown data type"<<dataType<<G4endl;
          throw G4HadronicException(__FILE__, __LINE__, "ParticleHPFSFissionFS::Init: unknown data type");
          break;
      }
    }
  ...
  G4DynamicParticleVector * ParticleHPFSFissionFS::ApplyYourself(G4int nPrompt, 
...
void ParticleHPFSFissionFS::SampleNeutronMult(G4int&all, G4int&Prompt, G4int&delayed, G4double eKinetic, G4int off)
{
...
G4DynamicParticleVector * ParticleHPFSFissionFS::GetPhotons()
{
// sample photons
