...
//
#include "ParticleHPFissionBaseFS.hh"
...
#include "ParticleHPDataUsed.hh"
  ...
  void ParticleHPFissionBaseFS::Init (G4double A, G4double Z, G4int M, G4String & dirName, G4String & bit, G4ParticleDefinition*)
  {
...
G4DynamicParticleVector * ParticleHPFissionBaseFS::ApplyYourself(G4int nPrompt)
  {  
