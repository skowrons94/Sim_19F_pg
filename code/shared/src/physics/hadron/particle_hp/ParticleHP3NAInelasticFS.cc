...
ParticleHP3NAInelasticFS::ParticleHP3NAInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID("model_ParticleHP3NAInelasticFS_F09");
}

G4HadFinalState* ParticleHP3NAInelasticFS::ApplyYourself(const G4HadProjectile& theTrack)
{
...
void ParticleHP3NAInelasticFS::Init(G4double A, G4double Z, G4int M, G4String& dirName,
