...
G4ThreadLocal WendtFissionFragmentGenerator* WendtFissionFragmentGenerator::instance = NULL;
...
/*
WendtFissionFragmentGenerator* WendtFissionFragmentGenerator::
GetInstance()
{
    //static WendtFissionFragmentGenerator newMe;
    //
    //return &newMe;
...
*/
G4HadFinalState* WendtFissionFragmentGenerator::
...
void WendtFissionFragmentGenerator::
...
//G4FFG_FUNCTIONENTER__
    ...
    if(newIsotope.second || newIsotope.first->second == NULL)
    {
        // Get the data file
        G4bool flag;
        ParticleHPDataUsed dataFile = fileNames.GetName(A, Z, M, dataDirectory, "FF", flag);
        ...
        ParticleHPManager::GetInstance()->GetDataStream(dataFileName, dataStream);
        if(!dataStream)
        {
            //G4FFG_FUNCTIONLEAVE__
