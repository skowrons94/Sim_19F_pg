#ifndef ParticleCaptureXS_h
#define ParticleCaptureXS_h 1
...
class ParticleCaptureXS final : public G4VCrossSectionDataSet
{
public: 

  explicit ParticleCaptureXS(const G4ParticleDefinition*);

  ~ParticleCaptureXS() override = default;
  ...
  ParticleCaptureXS & operator=
  (const ParticleCaptureXS &right) = delete;
  ParticleCaptureXS(const ParticleCaptureXS&) = delete;
...
private: 
  ...
  static G4Mutex particleCaptureXSMutex;
#endif
};

inline
const G4PhysicsVector* ParticleCaptureXS::GetPhysicsVector(G4int Z)
{
