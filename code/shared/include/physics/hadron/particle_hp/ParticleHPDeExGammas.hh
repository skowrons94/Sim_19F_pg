...
//
#ifndef ParticleHPDeExGammas_h
#define ParticleHPDeExGammas_h 1
...
class ParticleHPDeExGammas
{
  public:
  
  ParticleHPDeExGammas() 
  {
    levelStart = 0;
    levelSize = 0;
    nLevels = 0;
  ...
  inline ParticleHPLevel * GetLevel(G4int i)
  {
