...
//
#ifndef ParticleHPFinalState_h
#define ParticleHPFinalState_h
...
class ParticleHPFinalState
{
public:

  ParticleHPFinalState()
  { 
    hasFSData = true; 
    hasXsec = true;
    hasAnyData = true;
  ...
  // this would better be done templating ParticleHPChannel..., 
  // 
  ...
  virtual ParticleHPVector * GetXsec() { return 0; }
  ...
  void SetAZMs(G4double anA, G4double aZ, G4int aM, ParticleHPDataUsed used) 
  {
