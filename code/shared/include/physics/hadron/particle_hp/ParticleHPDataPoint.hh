...
//
#ifndef ParticleHPDataPoint_h
#define ParticleHPDataPoint_h 1

#include "globals.hh"

class ParticleHPDataPoint
{
  public:
  
  ParticleHPDataPoint(){energy = 0; xSec = 0;}
  ParticleHPDataPoint(G4double e, G4double x){ energy = e; xSec = x;}
  
  ParticleHPDataPoint & operator= (const ParticleHPDataPoint & aSet) = default;
