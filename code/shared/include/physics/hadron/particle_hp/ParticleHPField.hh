...
//
#ifndef ParticleHPField_h
#define ParticleHPField_h 1

#include "ParticleHPFieldPoint.hh"
#include "G4PhysicsVector.hh"

class ParticleHPField
{
  public:
  ...
  inline ParticleHPFieldPoint & GetPoint(G4int i) { return theData[i]; }
