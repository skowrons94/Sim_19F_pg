...
//
#ifndef ParticleHPDiscreteTwoBody_h
#define ParticleHPDiscreteTwoBody_h 1
...
class ParticleHPDiscreteTwoBody : public G4VParticleHPEnergyAngular
{
  public:
  
  ParticleHPDiscreteTwoBody()
  {
    theCoeff = 0;
  ...
  void Init(std::istream & aDataFile)
  {
    ...
    theCoeff = new ParticleHPLegendreTable[nEnergy];
    for(G4int i=0; i<nEnergy; i++)
    {
      G4double energy;
      G4int aRep, nCoeff;
      aDataFile >> energy >> aRep >> nCoeff;
      //-      G4cout << this << " " << i << " ParticleHPDiscreteTwoBody READ DATA " << energy << " " << aRep << " " << nCoeff << G4endl;
      energy*=CLHEP::eV;
