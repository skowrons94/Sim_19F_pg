...
//
#ifndef ParticleHPLabAngularEnergy_h
#define ParticleHPLabAngularEnergy_h 1
...
class ParticleHPLabAngularEnergy : public G4VParticleHPEnergyAngular
{
  public:
  
  ParticleHPLabAngularEnergy()
  {
    theEnergies = 0;
    theData = 0;
    nCosTh = 0;
