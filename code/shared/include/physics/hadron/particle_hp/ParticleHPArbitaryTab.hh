...
//
#ifndef ParticleHPArbitaryTab_h
#define ParticleHPArbitaryTab_h 1
...
class ParticleHPArbitaryTab : public VParticleHPEDis
{
  public:
  ParticleHPArbitaryTab()
  {
   theDistFunc = 0;
   nDistFunc = 0;
  }
  ...
  inline void Init(std::istream & theData)
  {
    ...
    theDistFunc = new ParticleHPVector [nDistFunc];
  ...
  ParticleHPVector * theDistFunc; // one per incoming energy
