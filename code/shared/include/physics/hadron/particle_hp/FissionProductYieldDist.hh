...
//
/*
 * File:   FissionProductYieldDist.hh
...
/** FissionProductYieldDist is the base class for storing all the fission
 *  data and generating fission events. */
class FissionProductYieldDist
{
public:
...
// Variables
    // Class descriptor variables
         ...
         *  FissionProductYieldDist references
         */
        const G4int Isotope_;
        /** MetaState information of the isotope that FissionProductYieldDist
         *  references
    ...
    // Fission generation variables
         ...
         *  isotope and incident neutron energy that FissionProductYieldDist
         *  references.
         */
    ...
    // Pointers to runtime classes that FissionProductYieldDist needs to
    // function properly
...
//Functions
     ...
     *  FissionProductYieldDistdefined from the data sets defined in
     *  SpecialOps.hh
     */
    void SetNubar( void );
...
public:
     ...
     *  FissionProductYieldDist is a parent class
     */
    virtual ~FissionProductYieldDist( void );
protected:
