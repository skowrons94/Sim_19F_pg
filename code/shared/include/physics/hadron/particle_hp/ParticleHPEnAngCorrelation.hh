...
//
#ifndef ParticleHPEnAngCorrelation_h
#define ParticleHPEnAngCorrelation_h 1
...
class ParticleHPEnAngCorrelation
{
   struct toBeCached
   {
...
public:
  ...
  ParticleHPEnAngCorrelation() // for ParticleHPCaptureFS::theMF6FinalState
  {
  ...
  ParticleHPEnAngCorrelation(G4ParticleDefinition* proj)
    : theProjectile(proj)
  {
    theProducts = 0;
    inCharge = false;
  ...
  inline void Init(std::istream & aDataFile)
  {
    ...
    theProducts = new ParticleHPProduct[nProducts];
