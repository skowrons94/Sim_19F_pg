...
//
#ifndef ParticleHPPhotonDist_h
#define ParticleHPPhotonDist_h 1
...
#include "ParticleHPLegendreTable.hh"
#include "ParticleHPAngularP.hh"
...
class ParticleHPPhotonDist
{
public:

  ParticleHPPhotonDist()
      : repFlag( 0 ) 
      , targetMass( 0.0 ) 
      , nDiscrete( 0 ) 
      , isoFlag( 0 )
...
//     DHW: not created in this class 
  ...
  void InitPartials(std::istream& aDataFile, ParticleHPVector* theXsec = 0);
...
private:
   ...
   ParticleHPVector* theYield; // multiplicity as a function of neutron energy.
   ParticleHPVector theTotalXsec;
   ParticleHPVector* thePartialXsec;
   ParticleHPVector* theReactionXsec;
   G4int* isPrimary;
   ...
   ParticleHPLegendreTable ** theLegendre;
   ParticleHPAngularP ** theAngular;
   
   G4int * distribution; // not used for the moment.                                 
   G4int nPartials;
   ParticleHPVector *  probs; // probabilities for the partial distributions.
   ParticleHPPartial ** partials; // the partials, parallel to the above
