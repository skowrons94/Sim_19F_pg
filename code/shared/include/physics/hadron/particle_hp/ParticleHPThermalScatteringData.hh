...
//
#ifndef ParticleHPThermalScatteringData_h
#define ParticleHPThermalScatteringData_h 1
...
class ParticleHPThermalScatteringData : public G4VCrossSectionDataSet
{

   public:

      ParticleHPThermalScatteringData();
   ...
   private:
      ...
      G4double GetX ( const G4DynamicParticle* , G4double aT , std::map< G4double , ParticleHPVector* >* );
...
//              element            temp       x section from E
      std::map< G4int , std::map< G4double , ParticleHPVector* >* >* coherent;
      std::map< G4int , std::map< G4double , ParticleHPVector* >* >* incoherent;
      std::map< G4int , std::map< G4double , ParticleHPVector* >* >* inelastic;

      std::map< G4double , ParticleHPVector* >* readData ( G4String ); 

      std::vector < G4int > indexOfThermalElement;
      ParticleHPThermalScatteringNames* names;
//              G4Element  NDL name 
