...
//
#ifndef ParticleHPFastLegendre_h
#define ParticleHPFastLegendre_h 1

#include "globals.hh"

class ParticleHPFastLegendre
{
  public:
  
  ParticleHPFastLegendre()
  {
  ...
  G4double Integrate(G4int l, G4double costh)
  {
    ...
    G4double y1, y2;
//    G4cout <<"Testhpw ParticleHPFastLegendre::Integrate "<<l<<" "<<bin<<G4endl;
    y1 = integral[l][bin];
    y2 = integral[l][bin+1];
//    G4cout <<"Testhpw ParticleHPFastLegendre::Integrate exit"<<G4endl;
