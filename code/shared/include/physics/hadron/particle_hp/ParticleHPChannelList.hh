...
//
#ifndef ParticleHPChannelList_h
#define ParticleHPChannelList_h 1
...
{      
  ...
  ParticleHPChannelList(G4int n, G4ParticleDefinition* projectile);
  
  ParticleHPChannelList();
  ...
  void Register(ParticleHPFinalState *theFS, const G4String &aName);
