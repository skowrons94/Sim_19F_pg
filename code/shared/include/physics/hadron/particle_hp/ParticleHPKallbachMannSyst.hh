...
#ifndef ParticleHPKallbachMannSyst_h
#define ParticleHPKallbachMannSyst_h 1

#include "globals.hh"

class ParticleHPKallbachMannSyst
{
  public:
  
   ParticleHPKallbachMannSyst(G4double aCompoundFraction,
