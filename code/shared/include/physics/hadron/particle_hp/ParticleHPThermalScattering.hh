...
//
#ifndef ParticleHPThermalScattering_h
#define ParticleHPThermalScattering_h 1
...
class ParticleHPThermalScatteringData;
class ParticleHPElastic;
...
class ParticleHPThermalScattering : public G4HadronicInteraction
{
   public: 
  
      ParticleHPThermalScattering();
   ...
   private:
      ...
      ParticleHPThermalScatteringData* theXSection;

      ParticleHPElastic* theHPElastic;
