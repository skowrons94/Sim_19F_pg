...
//
#ifndef ParticleHPCaptureFS_h
#define ParticleHPCaptureFS_h 1
...
class ParticleHPCaptureFS : public ParticleHPFinalState
{
  public:
  ...
  {
   ParticleHPCaptureFS * theNew = new ParticleHPCaptureFS;
   return theNew;
  }
  ...
  ParticleHPPhotonDist theFinalStatePhotons;
   ...
   ParticleHPEnAngCorrelation theMF6FinalState;
   G4bool hasExactMF6;
