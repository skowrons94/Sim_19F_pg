...
//
#ifndef ParticleHPJENDLHEData_h
#define ParticleHPJENDLHEData_h 1
...
class ParticleHPJENDLHEData : public G4VCrossSectionDataSet
{
   public:
   
   ParticleHPJENDLHEData();
   ParticleHPJENDLHEData( G4String , G4ParticleDefinition* );
