...
//
#ifndef ParticleHPThermalScatteringNames_h
#define ParticleHPThermalScatteringNames_h 1
...
class ParticleHPThermalScatteringNames 
{
   public:
   
      ParticleHPThermalScatteringNames();
