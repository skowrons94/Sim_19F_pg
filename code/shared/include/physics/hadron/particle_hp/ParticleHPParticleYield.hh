...
//
#ifndef ParticleHPParticleYield_h
#define ParticleHPParticleYield_h 1

#include <CLHEP/Units/SystemOfUnits.h>

#include "globals.hh"
#include "ParticleHPVector.hh"
#include "ParticleHPPolynomExpansion.hh"
#include "ParticleHPList.hh"

class ParticleHPParticleYield
{
  public:
  ParticleHPParticleYield()
  {
    simpleMean = true;
    spontPrompt = true;
    hasPromptData = false;
  ...
  // total mean
  G4bool simpleMean;
  ParticleHPPolynomExpansion theMean;
  ParticleHPVector theSimpleMean;
  
  // Prompt neutrons
  G4bool hasPromptData;
  G4bool spontPrompt;
  ParticleHPVector thePrompt;
  G4double theSpontPrompt;
  
  // delayed neutrons
  G4bool hasDelayedData;
  G4bool spontDelayed;
  ParticleHPList thePrecursorDecayConstants;
  ParticleHPVector theDelayed;
