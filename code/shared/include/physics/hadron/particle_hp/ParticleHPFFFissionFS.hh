...
//
#ifndef ParticleHPFFFissionFS_h
#define ParticleHPFFFissionFS_h 1
...
class ParticleHPFFFissionFS : public ParticleHPFissionBaseFS
{
 
   public:
      ParticleHPFFFissionFS(){ hasXsec = false; }
      ~ParticleHPFFFissionFS();
      ...
      {
         ParticleHPFFFissionFS * theNew = new ParticleHPFFFissionFS;
         return theNew;
      }
