...
//
#ifndef ParticleHPInterpolator_h
#define ParticleHPInterpolator_h 1
...
class ParticleHPInterpolator
{
  public:
  
  ParticleHPInterpolator(){}
  ~ParticleHPInterpolator()
   {
...
inline G4double ParticleHPInterpolator::
            ...
            G4double x, G4double x1, G4double x2, G4double y1, G4double y2) const
{
  ...
  switch(theScheme)
  {
    ...
    default:
      ...
      throw G4HadronicException(__FILE__, __LINE__, "ParticleHPInterpolator::Carthesian Invalid InterpolationScheme");
      break;
  }
  return result;
}
