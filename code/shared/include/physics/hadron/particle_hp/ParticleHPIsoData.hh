...
//
#ifndef ParticleHPIsoData_h
#define ParticleHPIsoData_h 1
...
public:
  ...
  ~ParticleHPIsoData(){if(theChannelData!=0) delete theChannelData;}
  ...
  inline ParticleHPVector * MakeElasticData()
    {return theElasticData;}
  inline ParticleHPVector * MakeFissionData()
    {return theFissionData;}
  inline ParticleHPVector * MakeCaptureData()
    {return theCaptureData;}
  inline ParticleHPVector * MakeInelasticData()
    {return theInelasticData;}
  inline ParticleHPVector * MakeChannelData()
    {return theChannelData;}

  G4String GetName(G4int A, G4int Z, G4String base, G4String rest);
  
  inline void FillChannelData(ParticleHPVector * aBuffer)
  {
...
private:
  ...
  ParticleHPVector * theChannelData;
