...
//
#ifndef ParticleHPMadlandNixSpectrum_h
#define ParticleHPMadlandNixSpectrum_h 1
...
class ParticleHPMadlandNixSpectrum : public VParticleHPEDis
{
  public:
  ParticleHPMadlandNixSpectrum()
  {
    expm1 = G4Exp(-1.);
