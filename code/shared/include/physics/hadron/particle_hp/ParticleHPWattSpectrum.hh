...
//
#ifndef ParticleHPWattSpectrum_h
#define ParticleHPWattSpectrum_h 1
...
class ParticleHPWattSpectrum : public VParticleHPEDis
{
  public:
  ParticleHPWattSpectrum()
  {
    expm1 = G4Exp(-1.);
  }
  ~ParticleHPWattSpectrum()
  ...
  ParticleHPVector theApar;
  ParticleHPVector theBpar;
