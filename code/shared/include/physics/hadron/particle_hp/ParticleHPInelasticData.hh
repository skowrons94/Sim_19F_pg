...
//
#ifndef ParticleHPInelasticData_h
#define ParticleHPInelasticData_h 1
...
class ParticleHPInelasticData : public G4VCrossSectionDataSet
{
   public:
   
      ParticleHPInelasticData(G4ParticleDefinition* projectile = G4Neutron::Neutron());
   
      ~ParticleHPInelasticData();
