...
//
#ifndef ParticleHPContEnergyAngular_h
#define ParticleHPContEnergyAngular_h 1
...
class ParticleHPContEnergyAngular : public G4VParticleHPEnergyAngular
{
public:
  
  ParticleHPContEnergyAngular(G4ParticleDefinition* proj)
    : theProjectile(proj)
  {
    theAngular = 0;
  ...
  void Init(std::istream & aDataFile)
  {
    ...
    theAngular = new ParticleHPContAngularPar[nEnergy];
	...
	theAngular[i].PrepareTableInterpolation((ParticleHPContAngularPar*)0);
      }
#endif
    }
  }
...
private:
  ...
  ParticleHPContAngularPar * theAngular;
  
  G4Cache<G4double> currentMeanEnergy;
  G4Cache<ParticleHPContAngularPar*> fCacheAngular; //fix
