...
#ifndef ParticleHPInelasticCompFS_h
#define ParticleHPInelasticCompFS_h 1
...
class ParticleHPInelasticCompFS : public ParticleHPFinalState
{
  public:
  
    ParticleHPInelasticCompFS()
    {
      QI.resize(51);
      LR.resize(51);
    ...
    virtual ~ParticleHPInelasticCompFS()
    {
      for(G4int i=0; i<51; i++) {
    ...
    virtual ParticleHPVector* GetXsec() { return theXsection[50]; }
  ...
  protected:
    ...
    ParticleHPVector* theXsection[51];
    ParticleHPEnergyDistribution* theEnergyDistribution[51];
    ParticleHPAngular* theAngularDistribution[51];
    ParticleHPEnAngCorrelation* theEnergyAngData[51];
  
    ParticleHPPhotonDist* theFinalStatePhotons[51];
