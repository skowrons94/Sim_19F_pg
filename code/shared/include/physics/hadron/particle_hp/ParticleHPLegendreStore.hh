...
//
#ifndef ParticleHPLegendreStore_h
#define ParticleHPLegendreStore_h 1
...
class ParticleHPLegendreStore
{
  public:
  
  ParticleHPLegendreStore(G4int n)
  {
    theCoeff = new ParticleHPLegendreTable[n];
    nEnergy = n;
  }
  
  ~ParticleHPLegendreStore()
  {
    delete [] theCoeff;
  }
  ...
  inline void SetCoeff(G4int i, ParticleHPLegendreTable * theTable)
  {
    if(i>nEnergy) throw G4HadronicException(__FILE__, __LINE__, "LegendreTableIndex out of range");
    theCoeff[i] = *theTable;
// not here -- see ParticleHPPhotonDist.cc line 275
//    delete theTable;
  }
  ...
  G4int nEnergy;
  ParticleHPLegendreTable * theCoeff;
