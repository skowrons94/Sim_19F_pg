...
//
#ifndef ParticleHPLegendreTable_h
#define ParticleHPLegendreTable_h 1
...
class ParticleHPLegendreTable
{
  public:
  ParticleHPLegendreTable()
  {
    nCoeff=0; 
    theCoeff = 0;
    theRep = 0;
  ...
  ~ParticleHPLegendreTable(){if(theCoeff!=0) delete [] theCoeff;}
  
  void operator= (const ParticleHPLegendreTable & aSet)
  {
    if(&aSet!=this)
    {
      theRep = aSet.theRep;
  ...
  inline void Init(G4double e, G4int n)
  {
    ...
    theCoeff[0]=1.;
    theEnergy = e;
//    G4cout << "ParticleHPLegendreTable::Init called "<<e<<" "<<n<<G4endl;
  }
