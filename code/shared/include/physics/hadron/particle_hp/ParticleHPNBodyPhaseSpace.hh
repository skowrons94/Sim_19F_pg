...
//
#ifndef ParticleHPNBodyPhaseSpace_h
#define ParticleHPNBodyPhaseSpace_h 1
...
class ParticleHPNBodyPhaseSpace : public G4VParticleHPEnergyAngular
{
  public:
  
  ParticleHPNBodyPhaseSpace(){
   theTotalMass = 0.0;
   theTotalCount = 0;
  }
  ~ParticleHPNBodyPhaseSpace(){}
