...
//
#ifndef ParticleHPBGGNucleonInelasticXS_h
#define ParticleHPBGGNucleonInelasticXS_h
...
class ParticleHPBGGNucleonInelasticXS : public G4BGGNucleonInelasticXS 
{
public:

  ParticleHPBGGNucleonInelasticXS (const G4ParticleDefinition*);

  virtual ~ParticleHPBGGNucleonInelasticXS();
