...
//
#ifndef ParticleHPFieldPoint_h
#define ParticleHPFieldPoint_h 1

#include "globals.hh"

class ParticleHPFieldPoint
{
  public:
  
  ParticleHPFieldPoint()
  {
    X = 0;
    nP = 0;
    Y = 0;
  ...
  ParticleHPFieldPoint(G4int n);
  
  void operator= (const ParticleHPFieldPoint & aSet);
