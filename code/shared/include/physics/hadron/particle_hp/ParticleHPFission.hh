...
#ifndef ParticleHPFission_h
#define ParticleHPFission_h 1
...
class ParticleHPFission : public G4HadronicInteraction
{
  public: 
  ...
  //ParticleHPChannel * theFission;
      std::vector<ParticleHPChannel*>* theFission;
  G4String dirName;
  G4int numEle;
